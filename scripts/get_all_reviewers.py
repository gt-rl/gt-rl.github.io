...
if __name__ == "__main__":
    ...
    group = client.get_group("logconference.io/LOG/2022/Conference/Reviewers")
    for member in group.members:
        ...
        email = profile.content.get("preferredEmail", profile.content["emails"][0])
        print(f"{member},{name},{email}")

    raise "heck"

    for id in [
        "ICLR.cc/2021/Workshop/GTRL/Reviewers",
